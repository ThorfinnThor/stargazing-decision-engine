...
test("destination pages support live darkness or the upcoming night for all 200 observation sites throughout the day", () => {
  ...
  assert.equal(destinations.length, 100);
