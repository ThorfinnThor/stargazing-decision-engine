...
test("all fifty location tours are bilingual, sourced, and structurally varied", () => {
  ...
  assert.deepEqual(
    ...
    new Set(["sierra-nevada", "pico-do-arieiro", "el-leoncito", "cerro-paranal", "la-silla", "cederberg", "central-tasmania", "gobi", "bieszczady", "rila"]),
  );
});
