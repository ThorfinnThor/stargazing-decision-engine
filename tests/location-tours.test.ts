...
test("the first forty location tours are bilingual, sourced, and structurally varied", () => {
  ...
  assert.deepEqual(
    new Set(tours.slice(-20).map((tour) => tour.destinationId)),
    new Set(["canyonlands", "north-york-moors", "hortobagy", "zselic", "witsand", "al-wathba", "grasslands", "mont-megantic", "natural-bridges", "great-sand-dunes", "mcdonald-observatory", "anza-borrego", "brecon-beacons", "eifel", "kielder", "exmoor", "uluru", "kitt-peak", "elqui-valley", "warrumbungle"]),
  );
});
