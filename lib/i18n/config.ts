...
export const localeCopy = {
  en: {
    ...
    lede: "A data-driven guide to stargazing conditions—built from reproducible climate and astronomy snapshots.",
  ...
  de: {
    ...
    lede: "Ein datenbasierter Wegweiser für Sternbeobachtung auf Basis reproduzierbarer Klima- und Astronomie-Snapshots.",
