  ...
  return (
    <main className="event-page" lang={isGerman ? "de" : "en"}>
      ...
      <header className="event-header">
        ...
        <p className="lede">{isGerman ? "Historische Seed-Werte und Monatskontext für die Beobachtungsplanung." : "Historical seed values and monthly context for planning an observing trip."}</p>
        <p className="event-note">{isGerman ? "Seed-Daten mit niedriger Konfidenz; keine Live-Wettervorhersage." : "Seed data with low confidence; not a live weather forecast."}</p>
      </header>
