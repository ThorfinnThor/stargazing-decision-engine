...
export default async function MethodologyPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return (
    <main className="event-page" lang={isGerman ? "de" : "en"}>
      ...
      <section className="event-summary" aria-labelledby="method-independence-title"><h2 id="method-independence-title">{isGerman ? "Redaktionelle Unabhängigkeit" : "Editorial independence"}</h2><p>{isGerman ? "Eine mögliche Provision verändert weder Vergleichskriterien noch Schlussfolgerungen. Kommerzielle Links werden als solche gekennzeichnet; Partner können keine Platzierung kaufen. Unsere Guides bleiben auch ohne Affiliate-Link vollständig lesbar." : "A potential commission does not change comparison criteria or conclusions. Commercial links are identified; partners cannot buy placement. Every guide remains complete without an affiliate link."}</p><p>{isGerman ? "Wir verlinken nur konkrete Aktivitäten, deren Produktseite wir einzeln auf Thema und Region geprüft haben. Wo kein passendes Angebot auffindbar ist, erscheint kein Affiliate-Modul. Preise, Bewertungen und Verfügbarkeiten übernehmen wir nicht in den Katalog, weil sie sich ändern können." : "We link only to specific activities whose product pages we have checked individually for subject and location. Where no suitable option is available, no affiliate module is shown. Prices, ratings, and availability are not copied into the catalog because they can change."}</p></section>
