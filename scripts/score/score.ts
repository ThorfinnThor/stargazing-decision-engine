...
const profiles: Record<string, ScoreProfile> = {
  ...
  exmoor: { clear: 0.42, darkness: 72, elevation: 38, comfort: 58, dew: 0.54, highLatitude: true },
  kielder: { clear: 0.4, darkness: 76, elevation: 34, comfort: 54, dew: 0.58, highLatitude: true },
  eifel: { clear: 0.48, darkness: 68, elevation: 42, comfort: 62, dew: 0.48, highLatitude: true },
  "brecon-beacons": { clear: 0.43, darkness: 70, elevation: 48, comfort: 58, dew: 0.55, highLatitude: true },
  montsec: { clear: 0.68, darkness: 82, elevation: 62, comfort: 74, dew: 0.22 },
  "sierra-nevada": { clear: 0.78, darkness: 87, elevation: 94, comfort: 68, dew: 0.14 },
  "pico-do-arieiro": { clear: 0.63, darkness: 76, elevation: 74, comfort: 66, dew: 0.28 },
  "death-valley": { clear: 0.88, darkness: 96, elevation: 34, comfort: 76, dew: 0.05 },
  canyonlands: { clear: 0.84, darkness: 95, elevation: 58, comfort: 65, dew: 0.08 },
  "great-sand-dunes": { clear: 0.78, darkness: 91, elevation: 82, comfort: 55, dew: 0.12 },
  "natural-bridges": { clear: 0.86, darkness: 97, elevation: 58, comfort: 62, dew: 0.07 },
  "anza-borrego": { clear: 0.86, darkness: 92, elevation: 28, comfort: 78, dew: 0.08 },
  "mcdonald-observatory": { clear: 0.82, darkness: 90, elevation: 72, comfort: 70, dew: 0.1 },
  "mont-megantic": { clear: 0.52, darkness: 78, elevation: 68, comfort: 48, dew: 0.42, highLatitude: true },
  grasslands: { clear: 0.62, darkness: 88, elevation: 46, comfort: 52, dew: 0.24, highLatitude: true },
  "el-leoncito": { clear: 0.88, darkness: 96, elevation: 94, comfort: 56, dew: 0.05 },
  "cerro-paranal": { clear: 0.93, darkness: 99, elevation: 98, comfort: 54, dew: 0.02 },
  "la-silla": { clear: 0.91, darkness: 98, elevation: 96, comfort: 56, dew: 0.03 },
  cederberg: { clear: 0.78, darkness: 92, elevation: 56, comfort: 68, dew: 0.1 },
  sutherland: { clear: 0.86, darkness: 96, elevation: 78, comfort: 60, dew: 0.05 },
  kalahari: { clear: 0.82, darkness: 94, elevation: 48, comfort: 70, dew: 0.06 },
  "central-tasmania": { clear: 0.52, darkness: 84, elevation: 58, comfort: 48, dew: 0.4 },
