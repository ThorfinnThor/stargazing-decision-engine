...
import type { DarknessCurveConfig } from "../../lib/darkness/calibration/types.js";
...
const darknessSnapshot = readJson<BlackMarbleSnapshot>(resolve(root, "data-snapshots/black-marble", `${siteSlug}.json`));
const darknessCurve = readJson<DarknessCurveConfig>(resolve(root, "data-config/scoring/darkness.json"));
const darkness = applyDarknessCurve(darknessSnapshot, darknessCurve);
