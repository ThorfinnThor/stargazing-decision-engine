...
for (const locale of config.locales) {
  ...
  pages.push(makePage({
    ...
    title: locale === "de" ? "Standort-Touren für Sternbeobachtung" : "Stargazing location tours", h1: locale === "de" ? "Vierzig Orte, vierzig unterschiedliche Nächte." : "Forty places, forty different nights.",
